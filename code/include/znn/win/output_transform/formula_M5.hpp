...
out[OS * 4] = SIMD_ADD(out[OS * 4],in[IS * 6]);
...
out[OS * 4] = SIMD_ADD(out[OS * 4],in[IS * 7]);
...
out[OS * 4] = SIMD_ADD(out[OS * 4],in[IS * 8]);
...
out[OS * 4] = SIMD_ADD(out[OS * 4],in[IS * 9]);
