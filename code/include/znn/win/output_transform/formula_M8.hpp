...
SIMD_FLOAT C729 = SIMD_SET1(729.0f);
SIMD_FLOAT C4096 = SIMD_SET1(4096.0f);
SIMD_FLOAT C128 = SIMD_SET1(128.0f);
SIMD_FLOAT C2187 = SIMD_SET1(2187.0f);
SIMD_FLOAT C16384 = SIMD_SET1(16384.0f);
...
out[OS * 6] = SIMD_ADD(in[IS],in[IS * 2]);
out[OS * 6] = SIMD_FMADD(in[IS * 3],C64,out[OS * 6]);
out[OS * 6] = SIMD_FMADD(in[IS * 4],C64,out[OS * 6]);
out[OS * 6] = SIMD_FMADD(in[IS * 5],C729,out[OS * 6]);
out[OS * 6] = SIMD_FMADD(in[IS * 6],C729,out[OS * 6]);
out[OS * 6] = SIMD_FMADD(in[IS * 7],C4096,out[OS * 6]);
out[OS * 6] = SIMD_FMADD(in[IS * 8],C4096,out[OS * 6]);

out[OS * 7] = SIMD_SUB(in[IS],in[IS * 2]);
out[OS * 7] = SIMD_FMADD(in[IS * 3],C128,out[OS * 7]);
out[OS * 7] = SIMD_FNMADD(in[IS * 4],C128,out[OS * 7]);
out[OS * 7] = SIMD_FMADD(in[IS * 5],C2187,out[OS * 7]);
out[OS * 7] = SIMD_FNMADD(in[IS * 6],C2187,out[OS * 7]);
out[OS * 7] = SIMD_FMADD(in[IS * 7],C16384,out[OS * 7]);
out[OS * 7] = SIMD_FNMADD(in[IS * 8],C16384,out[OS * 7]);
out[OS * 7] = SIMD_ADD(out[OS * 7],in[IS * 9]);
...
out[6] = SIMD_ADD(in[IS],in[IS * 2]);
out[6] = SIMD_FMADD(in[IS * 3],C64,out[6]);
out[6] = SIMD_FMADD(in[IS * 4],C64,out[6]);
out[6] = SIMD_FMADD(in[IS * 5],C729,out[6]);
out[6] = SIMD_FMADD(in[IS * 6],C729,out[6]);
out[6] = SIMD_FMADD(in[IS * 7],C4096,out[6]);
out[6] = SIMD_FMADD(in[IS * 8],C4096,out[6]);

out[7] = SIMD_SUB(in[IS],in[IS * 2]);
out[7] = SIMD_FMADD(in[IS * 3],C128,out[7]);
out[7] = SIMD_FNMADD(in[IS * 4],C128,out[7]);
out[7] = SIMD_FMADD(in[IS * 5],C2187,out[7]);
out[7] = SIMD_FNMADD(in[IS * 6],C2187,out[7]);
out[7] = SIMD_FMADD(in[IS * 7],C16384,out[7]);
out[7] = SIMD_FNMADD(in[IS * 8],C16384,out[7]);
out[7] = SIMD_ADD(out[7],in[IS * 9]);
