...
out[OS] = SIMD_ADD(out[OS],in[IS * 3]);
...
out[OS] = SIMD_ADD(out[OS],in[IS * 4]);
...
out[OS] = SIMD_ADD(out[OS],in[IS * 5]);
...
out[OS] = SIMD_ADD(out[OS],in[IS * 6]);
...
out[OS] = SIMD_ADD(out[OS],in[IS * 7]);
...
out[OS] = SIMD_ADD(out[OS],in[IS * 8]);
...
out[OS] = SIMD_ADD(out[OS],in[IS * 9]);
