...
typename std::enable_if<M == 4 && N == 3>::type
...
template <long_t M, long_t N, long_t OS, long_t IS>
inline __attribute__((always_inline))
typename std::enable_if<M == 4 && N == 4>::type
out_image_1d(SIMD_FLOAT* __restrict out, SIMD_FLOAT const* __restrict in)
{
SIMD_FLOAT C2 = SIMD_SET1(2.0f);
...
out[OS * 3] = SIMD_ADD(out[OS * 3],in[IS * 6]);
...
template <long_t M, long_t N, long_t OS, long_t IS>
inline __attribute__((always_inline))
typename std::enable_if<M == 4 && N == 5>::type
out_image_1d(SIMD_FLOAT* __restrict out, SIMD_FLOAT const* __restrict in)
{
SIMD_FLOAT C2 = SIMD_SET1(2.0f);
SIMD_FLOAT C3 = SIMD_SET1(3.0f);
...
out[OS * 3] = SIMD_ADD(out[OS * 3],in[IS * 7]);
...
template <long_t M, long_t N, long_t OS, long_t IS>
inline __attribute__((always_inline))
typename std::enable_if<M == 4 && N == 6>::type
out_image_1d(SIMD_FLOAT* __restrict out, SIMD_FLOAT const* __restrict in)
{
SIMD_FLOAT C2 = SIMD_SET1(2.0f);
SIMD_FLOAT C3 = SIMD_SET1(3.0f);
...
out[OS * 3] = SIMD_ADD(out[OS * 3],in[IS * 8]);
...
template <long_t M, long_t N, long_t OS, long_t IS>
inline __attribute__((always_inline))
typename std::enable_if<M == 4 && N == 7>::type
out_image_1d(SIMD_FLOAT* __restrict out, SIMD_FLOAT const* __restrict in)
{
SIMD_FLOAT C2 = SIMD_SET1(2.0f);
SIMD_FLOAT C3 = SIMD_SET1(3.0f);
...
out[OS * 3] = SIMD_ADD(out[OS * 3],in[IS * 9]);
