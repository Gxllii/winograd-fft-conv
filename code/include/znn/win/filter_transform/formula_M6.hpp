...
out[OS] = SIMD_FMADD(C1D48,in[IS],V12S);

out[OS * 2] = SIMD_FNMADD(C1D48,in[IS],V12S);

SIMD_FLOAT V34S = SIMD_MUL(in[0],CN1D120);
V34S = SIMD_FNMADD(in[IS * 2],C1D30,V34S);

out[OS * 3] = SIMD_FNMADD(C1D60,in[IS],V34S);

out[OS * 4] = SIMD_FMADD(C1D60,in[IS],V34S);

SIMD_FLOAT V56S = SIMD_MUL(in[0],C1D720);
V56S = SIMD_FMADD(in[IS * 2],C1D80,V56S);

out[OS * 5] = SIMD_FMADD(C1D240,in[IS],V56S);

out[OS * 6] = SIMD_FNMADD(C1D240,in[IS],V56S);
...
out[1] = SIMD_FMADD(C1D48,in[IS],V12S);

out[2] = SIMD_FNMADD(C1D48,in[IS],V12S);

SIMD_FLOAT V34S = SIMD_MUL(in[0],CN1D120);
V34S = SIMD_FNMADD(in[IS * 2],C1D30,V34S);

out[3] = SIMD_FNMADD(C1D60,in[IS],V34S);

out[4] = SIMD_FMADD(C1D60,in[IS],V34S);

SIMD_FLOAT V56S = SIMD_MUL(in[0],C1D720);
V56S = SIMD_FMADD(in[IS * 2],C1D80,V56S);

out[5] = SIMD_FMADD(C1D240,in[IS],V56S);

out[6] = SIMD_FNMADD(C1D240,in[IS],V56S);
