...
out[OS] = SIMD_FMADD(CN1D6,in[IS],V12S);

out[OS * 2] = SIMD_FNMADD(CN1D6,in[IS],V12S);

SIMD_FLOAT V34S = SIMD_MUL(in[0],C1D24);
V34S = SIMD_FNMADD(in[IS * 2],CN1D6,V34S);

out[OS * 3] = SIMD_FMADD(C1D12,in[IS],V34S);

out[OS * 4] = SIMD_FNMADD(C1D12,in[IS],V34S);
...
out[1] = SIMD_FMADD(CN1D6,in[IS],V12S);

out[2] = SIMD_FNMADD(CN1D6,in[IS],V12S);

SIMD_FLOAT V34S = SIMD_MUL(in[0],C1D24);
V34S = SIMD_FNMADD(in[IS * 2],CN1D6,V34S);

out[3] = SIMD_FMADD(C1D12,in[IS],V34S);

out[4] = SIMD_FNMADD(C1D12,in[IS],V34S);
