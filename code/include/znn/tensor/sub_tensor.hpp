...
public:
    ...
    {
        return super_type::access(type_t<const_reference>(), i, ptr_,
                                  extents_, strides_);
    }

    zi2::vl::vec<long_t, D> shape_vec() const
    {
        return zi2::vl::vec<long_t, D>(zi2::vl::load, extents_);
    }
...
public:
    ...
    {
        return super_type::access(type_t<reference>(), i, super_type::ptr_,
                                  super_type::extents_, super_type::strides_);
    }
