...
struct output_transform_t
{
    ...
    static constexpr long_t flat_tile_stride = tile_elements * SIMD_WIDTH * 2;
...
template <class InSize, class InStride, class OutSize, class OutStride,
          class TSize, class KSize, long_t RowBlock = 15, long_t MaxK = 128,
